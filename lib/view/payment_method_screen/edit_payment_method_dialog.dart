...
Future<void> editPaymentMethodDialog(BuildContext context, int index) async {
  ...
  showDialog(
      ...
      builder: (context) {
        ...
        paymentController.text = paymentProvider.paymentMethods[index].details;
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
                onPressed: () {
                  paymentProvider.updatePaymentMethod(
                      index, paymentController.text);
                  Navigator.pop(context);
                },
                child: const Text(
                  'SAVE',
