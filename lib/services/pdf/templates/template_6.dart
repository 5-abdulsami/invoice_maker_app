...
/// Template 6 - the "Modern" invoice layout.
class Template6 extends BaseTemplate {
  const Template6();

  @override
  InvoiceTemplate get id => InvoiceTemplate.template6;
    ...
    pw.Widget buildHeader(pw.Context context) {
      return pw.Container(
        decoration: const pw.BoxDecoration(
          ...
          colors: [PdfColors.purple900, PdfColors.purple300],
        )),
    ...
    pw.Widget buildFooter(pw.Context context) {
      return pw.Container(
        decoration: const pw.BoxDecoration(
          ...
          colors: [PdfColors.purple300, PdfColors.purple900],
        )),
  ...
  pw.Widget buildTable(List<Item> items, Currency currency) {
    ...
    return pw.TableHelper.fromTextArray(
      oddRowDecoration: const pw.BoxDecoration(color: PdfColors.purple50),
